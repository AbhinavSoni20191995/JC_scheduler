...
- End-of-round fairness: an admin "end of semester/quarter" tally gives a
  priority boost to anyone who didn't present at all (or had to cancel) that
  round, so they present more often and earlier next round; presenters reset.
  Boost takes effect on the next generate/rebuild. An optional start date can
