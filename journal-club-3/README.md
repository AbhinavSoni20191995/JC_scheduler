...
- One-time Excel sync (EXCEL_SEED in app.py): existing manual rotation is
  written into the schedule on first start, then the rotation continues from
  where the Excel left off.
